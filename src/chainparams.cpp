...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000000000000000000000000000000000000000000000000000000100010001"));
    //(1, uint256("0x00000a986ce620e0161155f31fa994139af9c61b0582e1e9063f2f2a216a590f"));
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1634607102; // 14 - apr - 2018
        ...
        genesis.nNonce = 199;
        printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str(), genesis.MerkleRoot().ToString().c_str());
